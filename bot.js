 ...
 **
__~~ Starex System ~~__ By: ! 'Sr , AÕ .#0001
╔[❖════════════❖]╗
             Prefix = ' # '
╚[❖════════════❖]╝
╔[❖════════════❖]╗
...
client.on('guildMemberAdd', member => {
    let channel = member.guild.channels.find('name', 'starex');
...
const adminprefix = "#";
const devs = ['523249982938021908','462038057529507841'];
client.on('message', message => {
